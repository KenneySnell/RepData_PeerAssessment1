...
```{r plot2, echo=TRUE,fig.width=8, fig.height=6, inlcude =TRUE}
...
```{r plot4, echo=TRUE,fig.width=8, fig.height=6, inlcude =TRUE}
histData <-  aggregate(steps ~ date, data = activity_cpl, sum)
Median_steps <- median(histData$steps)
...
```{r plothist1, echo=TRUE,fig.width=8, fig.height=6, inlcude =TRUE}
...
```{r plot8, echo=TRUE,width=8, fig.height=6, inlcude =TRUE}
...
```{r timeplot2, echo=TRUE, fig.width=8, fig.height=6, inlcude =TRUE}
